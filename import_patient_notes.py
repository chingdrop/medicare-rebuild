...
patient_note_df = pd.merge(notes_df, time_df, on=['Note_ID', 'SharePoint_ID', 'AZURE_UPN'], how='left')
...
patient_note_df.loc[patient_note_df['AZURE_UPN'].isin(nurse_list), 'Recording_Time'] = 900
patient_note_df['Recording_Time'] = patient_note_df['Recording_Time'].fillna(0)
patient_note_df.loc[patient_note_df['AZURE_UPN'].isin(nurse_list), 'Time_Note'] = 'Initial Evaluation'
...
patient_note_df.loc[patient_note_df['AZURE_UPN'].isin(alert_team_list), 'Time_Note'] = 'Alert'
