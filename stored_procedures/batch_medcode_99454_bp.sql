...
-- Description:	Adds 99454 code to medical code for patients with blood pressure monitors.
-- =============================================
CREATE PROCEDURE batch_medcode_99454_bp
...
BEGIN
	...
	WHERE bpr.received_datetime >= DATEADD(day, -30, GETDATE())
	AND bpr.patient_id IN (
